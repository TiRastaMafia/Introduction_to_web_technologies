<?php
$name = "Teftel";
$profession = "Mouse Catcher";
$city = "Astana";
$email = "teftelka@mouse.net";
...
$works = [
  [
    ...
    'description' => 'Developer что-то разрабатывает'
  ],
  [
    'name' => 'Аналитик',
    'dateStart' => 'Март 2015',
    'dateEnd' => 'Апрель 2019',
    'description' => 'Аналитик что-то анализирует'
  ],
  [
    'name' => 'Тестировщик',
    'dateStart' => 'Октябрь 2010',
    'dateEnd' => 'Февраль 2015',
    'description' => 'Тестировщик что-то тестирует'
  ],
];
?>
<!DOCTYPE html>
          ...
          <div class="w3-container">
            <?php for ($i = 0; $i < count($works); $i++) : ?>
              ...
              <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                <?= $works[$i]['dateStart'] ?> -
                <?php if ($i == 0) : ?>
                  <span class="w3-tag w3-teal w3-round"><?= $works[$i]['dateEnd'] ?></span>
                <?php else : ?>
                  <?= $works[$i]['dateEnd'] ?>
                <?php endif; ?>
